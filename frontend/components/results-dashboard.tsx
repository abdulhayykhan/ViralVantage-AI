...
export function ResultsDashboard({ analysis, transparencyData }: Readonly<ResultsDashboardProps>) {
  ...
  return (
    <Card className="glass-card hud-frame border-white/10 bg-card/70">
        ...
        {analysis ? (
          <motion.div className="space-y-5" variants={staggerContainer} initial="hidden" animate="visible">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <section className="glass-card hud-frame rounded-xl bg-background/40 p-4">
              ...
              <section className="glass-card hud-frame rounded-xl bg-background/40 p-4 md:col-span-2">
